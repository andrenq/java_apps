...
public class OrderDAO extends DataAccessObject<Order> {
    private static final String INSERT       = "INSERT INTO orders (order_id, creation_date,"
            + " total_due, status, customer_id, salesperson_id) VALUES (?,?,?,?,?,?,?)";
