  ...
  public static void main(String[] args) throws JsonProcessingException {
    ...
    String company =
            "{\n\"symbol\":\"AAPL\",\n\"companyName\":\"Apple Inc.\",\n\"exchange\":\"Nasdaq Global Select\",\n\"" +
                    "description\":\"Apple Inc is designs,manufactures and markets mobile communication and media devices " +
                    "and personal computers, and sells a variety of related software, services, accessories, networking " +
    ...
    try {
      comp = toObjectFromJson(company, comp.getClass());
    } catch (IOException e) {
      e.printStackTrace();
    }
    System.out.println(comp);
    System.out.println(toJson(comp, true, true));
  }
}
